...
| `gpt-image-1.5`         | GPT Image 1.5 — latest GPT-based image model                                         | High-fidelity, instruction-following generation     |
| `gpt-image-1.5-edit`    | GPT Image 1.5 edit variant                                                           | High-fidelity edits and inpainting                  |
