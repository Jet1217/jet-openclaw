...
```bash
# 1. Create a file list (paths use the shared project folder)
...
```bash
# Using curl (download into the shared project folder)
curl -L -o /data/projects/<slug>/clips/clip-01.mp4 "https://..."

# Using wget
wget -O /data/projects/<slug>/clips/clip-01.mp4 "https://..."
```
